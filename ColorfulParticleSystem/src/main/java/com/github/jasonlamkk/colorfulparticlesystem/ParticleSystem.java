...
import com.github.jasonlamkk.colorfulparticlesystem.initializers.AccelerationInitializer;
import com.github.jasonlamkk.colorfulparticlesystem.initializers.NeonLightInitializer;
import com.github.jasonlamkk.colorfulparticlesystem.initializers.ParticleInitializer;
import com.github.jasonlamkk.colorfulparticlesystem.initializers.RotationInitializer;
import com.github.jasonlamkk.colorfulparticlesystem.initializers.RotationSpeedInitializer;
import com.github.jasonlamkk.colorfulparticlesystem.initializers.ScaleInitializer;
import com.github.jasonlamkk.colorfulparticlesystem.initializers.SpeedModuleAndRangeInitializer;
import com.github.jasonlamkk.colorfulparticlesystem.initializers.SpeeddByComponentsInitializer;
import com.github.jasonlamkk.colorfulparticlesystem.modifiers.AlphaModifier;
import com.github.jasonlamkk.colorfulparticlesystem.modifiers.ParticleModifier;
...
public class ParticleSystem {
     ...
     *
     * @param startSize           The startSize factor
     * @param startSizeVariance   The startVariance scaling factor.
     * @param endSize             The endSize factor
     * @param endSizeVarianceSize The endSize Variance factor.
     * @return This.
     */
    public ParticleSystem setScaleRange(float startSize, float startSizeVariance, float endSize, float endSizeVarianceSize) {
        mInitializers.add(new ScaleInitializer(dpToPx(startSize), dpToPx(startSizeVariance), dpToPx(endSize), dpToPx(endSizeVarianceSize)));
        return this;
    }

    public ParticleSystem setColor(float redStart, float greenStart, float blueStart,
                                   float redStartVariance, float greenStartVariance, float blueStartVariance,
                                   float redEnd, float greenEnd, float blueEnd,
                                   float redEndVariance, float greenEndVariance, float blueEndVariance,
                                   float startAlpha, float startVarianceAlpha, float endAlpha, float endVarianceAlpha) {
        mInitializers.add(new NeonLightInitializer(redStart, greenStart, blueStart, redStartVariance, greenStartVariance,
                blueStartVariance, redEnd, greenEnd, blueEnd, redEndVariance, greenEndVariance, blueEndVariance, startAlpha,
                startVarianceAlpha, endAlpha, endVarianceAlpha));
        return this;
    }
